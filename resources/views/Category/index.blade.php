            ...
            <div class="card">
              <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                  <a class="btn ripple btn-primary" data-target="#modaldemo1" data-toggle="modal" href="categories/create">Add</a>
                  ...
                  <table class="table text-md-nowrap" id="example1">
                    ...
                    <tbody>
                        ...
                        <td> <a class="modal-effect btn btn-sm btn-danger" data-effect=" effect-scale"
                                                       data-id="{{$category->id}}" data-category_name="{{$category->name}}" data-toggle="modal"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="categories/update" method="post" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="category_name" id="category_id" type="text" value="">
                                            </div>
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="categories/destroy" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="id" id="id" value="">
                                        <input class="form-control" name="category_name" id="category_id" value="" type="text" readonly>
                                    </div>
                                    <div class="modal-footer">
