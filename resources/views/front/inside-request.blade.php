                ...
                <div class="path">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">طلب التبرع: {{$donations->patient_name}}</li>
                        </ol>
                    </nav>
                </div>
                <div class="details">
                            ...
                            <div class="col-md-6">
                                <div class="inside">
                                    <div class="info">
                                        ...
                                        <div class="light">
                                            <p dir="ltr">{{$donations->bloodType->name}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="inside">
                                    <div class="info">
                                        ...
                                        <div class="special-light light">
                                            <p>{{$donations->hospital_address}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
